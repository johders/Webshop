...
namespace PE1.Webshop.Web.Migrations
{
    ...
    [Migration("20240503053124_UpdateOrderAndUser")]
            ...
            modelBuilder.Entity("PE1.Webshop.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "Soete",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$uRqx5Ey49itrQgLIXszUrw$QhoDtwO7JLI+e9v/VKSpXza0UwUm4pTI5SOe95d2ZwQ",
                            Username = "bsoete"
                        },
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "Dereuddre",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$bVKJ+TcUG0GxbIY6OoZSvw$aQEkOyH4dIkqbtZOj9eCJXZxVQ7X+jhm/rTVxp0ekTs",
                            Username = "jders"
                        },
                        new
                        {
                            ...
                            IsAdmin = false,
                            LastName = "Mama",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$35YwlKM6bfoW9z2qYu6hEg$ui8MGm78kfQwh93v/99vSzl3bgwsx0wzodh0nZ604GA",
                            Username = "joemama"
                        },
                        new
                        {
                            ...
                            IsAdmin = false,
                            LastName = "Bobbers",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$ZNaCoG9+tCfqHBCOXJvqgA$MV+wAaGMN4ygL/ky5kloskzLc5BVIGDAQ6S4QV0jEZw",
                            Username = "bob"
                        });
                });
