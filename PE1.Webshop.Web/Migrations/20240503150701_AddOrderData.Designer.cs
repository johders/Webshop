...
namespace PE1.Webshop.Web.Migrations
{
    ...
    [Migration("20240503150701_AddOrderData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PE1.Webshop.Core.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "Soete",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$973eI2wyUhVS5a+aNQgwZg$q278YxcKa6ebKTFPKURrVy4bboT0XJLI8xDNYacToCE",
                            Username = "bsoete"
                        },
                        new
                        {
                            Id = 2,
                            Email = "johannes.dereuddre@ergens.be",
                            FirstName = "Johannes",
                            IsAdmin = true,
                            LastName = "Dereuddre",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$Dw+cpKIhTsjJeXtdlz3h5g$MyZTBYquk+kGZIeH+fG4k/iIgBjqUCozPy+2sx/VkhU",
                            Username = "jders"
                        },
                        new
                        {
                            ...
                            IsAdmin = false,
                            LastName = "Mama",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$iR3k3Rb15mu4Nzo2XlLKYw$yDM7LNMjQ6CvPjIZggv5HkKK4m8AhKTxIJf95T9BJ5c",
                            Username = "joemama"
                        },
                        new
                        {
                            Id = 4,
                            Email = "bob.bobbers@bob.be",
                            FirstName = "Bob",
                            IsAdmin = false,
                            LastName = "Bobbers",
                            Password = "$argon2id$v=19$m=65536,t=3,p=1$7UJkqSg77oSuJIlLzgNSug$5PRWZK7Xd8wG1VWaMoLi+YuM9jhZovXIVQbE6RZuQq0",
                            Username = "bob"
                        });
                });
            ...
            modelBuilder.Entity("PE1.Webshop.Core.WebOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6a106996-b534-466b-884c-f26437bf4017"),
                            OrderDate = new DateTime(2024, 5, 3, 17, 7, 1, 80, DateTimeKind.Local).AddTicks(7951),
                            Shipping = 0m,
                            Status = "Unshipped",
                            SubTotal = 83.5m,
                            TotalPrice = 83.5m,
                        ...
                        new
                        {
                            Id = new Guid("a1dcfd6a-bda1-419d-a946-a73b046cfc90"),
                            OrderDate = new DateTime(2024, 5, 3, 21, 7, 1, 80, DateTimeKind.Local).AddTicks(8024),
                            Shipping = 0m,
                            Status = "Completed",
                            SubTotal = 111m,
                            TotalPrice = 111m,
                        ...
                        new
                        {
                            Id = new Guid("1889c918-f35f-4cc3-b2b1-ffd7560eff90"),
                            OrderDate = new DateTime(2024, 5, 3, 17, 39, 1, 80, DateTimeKind.Local).AddTicks(8034),
                            Shipping = 3.95m,
                            Status = "Unshipped",
                            SubTotal = 58.5m,
                            TotalPrice = 62.45m,
                        ...
                        new
                        {
                            Id = new Guid("802bdd11-8b5b-440b-b2e2-699a4e6bb978"),
                            OrderDate = new DateTime(2024, 5, 3, 17, 51, 1, 80, DateTimeKind.Local).AddTicks(8038),
                            Shipping = 6.95m,
                            Status = "Completed",
                            SubTotal = 37.5m,
                            TotalPrice = 44.45m,
            ...
            modelBuilder.Entity("PE1.Webshop.Core.WebOrderCoffee", b =>
                {
                    ...
                    b.HasKey("WebOrderId", "CoffeeId");

                    b.HasIndex("CoffeeId");

                    b.ToTable("WebOrderCoffeeDetails", (string)null);

                    b.HasData(
                        new
                        {
                            WebOrderId = new Guid("6a106996-b534-466b-884c-f26437bf4017"),
                            CoffeeId = 12,
                            Quantity = 1,
                            UnitPrice = 18.5m
                        },
                        ...
                        new
                        {
                            WebOrderId = new Guid("a1dcfd6a-bda1-419d-a946-a73b046cfc90"),
                            CoffeeId = 5,
                            Quantity = 4,
                            UnitPrice = 19m
                        },
                        ...
                        new
                        {
                            WebOrderId = new Guid("1889c918-f35f-4cc3-b2b1-ffd7560eff90"),
                            CoffeeId = 16,
                            Quantity = 1,
                            UnitPrice = 21m
                        },
            ...
            modelBuilder.Entity("PE1.Webshop.Core.WebOrder", b =>
                {
                    b.HasOne("PE1.Webshop.Core.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("PE1.Webshop.Core.WebOrderCoffee", b =>
                {
                    b.HasOne("PE1.Webshop.Core.Coffee", "Coffee")
                        .WithMany("WebOrderCoffees")
                        .HasForeignKey("CoffeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PE1.Webshop.Core.WebOrder", "WebOrder")
                        .WithMany("WebOrderCoffees")
